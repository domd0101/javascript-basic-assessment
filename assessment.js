...
// #10 Write a function called removeItem that takes in an array of strings, and a string.
 function removeItem(arrStr,str){
	  arr = arrStr.filter(function(word){
					return word !== str;
			});
			return arr;
 }
...
*/
	...
	function outside(temp,humd,clod){
		if(temp>80 && humd>40){
			return "I'm all sweat"
		}
		else if(temp<40 && clod>60){
			return "I have icecicles"
		}
		else if(temp>80 && humd<40 && clod<20){
			return "I'm literally in the desert"
		}
		else if(temp>80 || humd>50 || clod>50){
